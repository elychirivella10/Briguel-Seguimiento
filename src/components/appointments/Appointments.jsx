...
//component
import NoteFile from 'components/notes/NotesFile'


const Appointments=({id,getNotes})=>{
    ...
    const insertAppointment = async (e)=>{
        ...
        const respuesta = await axios.post(`${rutaAxios}notes`,{note:note,id_task:id,id_user:1})
        .then(respuesta =>{
        ...
        <div className="box">
            <div className="field">
                <div className="control">
                    <p className=" has-text-weight-semibold mb-5">Agregar Nota</p>
            ...
            <button className = "button is-fullwidth is-blue" onClick={insertAppointment}>Guardar</button>
        </div>
    )
}
